...
const pb_field_t api_SensorData_fields[9] = {
    ...
    PB_FIELD(  6, MESSAGE , OPTIONAL, STATIC  , OTHER, api_SensorData, location, humidity, &api_Location_fields),
    PB_FIELD(  7, UINT32  , OPTIONAL, STATIC  , OTHER, api_SensorData, water_level, location, 0),
    PB_FIELD(110, UINT32  , REPEATED, CALLBACK, OTHER, api_SensorData, analog_readings, water_level, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(api_SensorData, location) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_api_Location_api_SensorData)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(api_SensorData, location) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_api_Location_api_SensorData)
#endif
